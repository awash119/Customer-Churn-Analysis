...
class Nominal_Encoding_Strategy(Feature_Encoding_Strategy):
    ...
    def encorder(self,df,columns):
        ...
        return df
class Ordinal_Encoding_Strategy(Feature_Encoding_Strategy):
    def __init__(self,ordinal_definitions):
        self.ordinal_definitions=ordinal_definitions

    def encorder(self,df,columns):
        def assign_value(value):
            return self.ordinal_definitions.get(value, value)
        df[columns]=df[columns].map(assign_value)
        return df
